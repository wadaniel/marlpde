...
import diffusion_environment_error as dee
...
dns_default = dee.setup_dns_default(args.ic, args.NDNS, args.dt, args.nu, T, args.seed)
...
e["Problem"]["Environment Function"] = lambda s : dee.environment( 
        s,
        N = args.N,
        tEnd = T,
        dtSgs = args.dt, 
...
for i in range(1):
    ...
    e["Variables"][nState+i]["Lower Bound"] = -1e-1
    e["Variables"][nState+i]["Upper Bound"] = +1e-1
