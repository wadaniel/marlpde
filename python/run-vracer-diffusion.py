...
parser.add_argument('--nu', help='Viscosity', required=False, type=float, default=0.01)
parser.add_argument('--tf', help='Testing frequency in episodes', required=False, type=int, default=1000)
parser.add_argument('--nt', help='Number of testing runs', required=False, type=int, default=25)
...
dns_default = de.setup_dns_default(args.ic, args.NDNS, args.dt, args.nu, args.tend, args.seed)
