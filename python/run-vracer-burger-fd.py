...
parser.add_argument('--N', help='Discretization / number of grid points of UGS', required=False, type=int, default=256)
parser.add_argument('--NA', help='Number of actions', required=False, type=int, default=256)
parser.add_argument('--NE', help='Number of experiences', required=False, type=int, default=1e6)
parser.add_argument('--width', help='Size of hidden layer', required=False, type=int, default=32)
parser.add_argument('--iex', help='Initial exploration', required=False, type=float, default=0.005)
...
parser.add_argument('--tf', help='Testing frequency in episodes', required=False, type=int, default=50)
...
import burger_fd_environment as be
import burger_testing_environment as bfdet

if args.ndns < args.nt:
    print("[run-vracer-burger-fd] increas the number of dns")
...
if args.test:
    print("[run-vracer-burger-df] todo..")
    exit()
