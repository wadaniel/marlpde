...
resultFolder = '_result_burger_{}_{}_{}_{}_{}_{}/'.format(args.ic, args.N, args.numactions, args.episodelength, args.seed, args.run)
...
e["Problem"]["Environment Function"] = lambda s : be.environment( s, args.N, args.numactions, args.episodelength, args.ic, args.seed )
