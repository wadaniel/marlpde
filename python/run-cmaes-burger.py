...
resultFolder = '_cmaes_burger_{}_{}_{}_{}_{}/'.format(args.ic, args.N, args.pop, args.episodelength, args.run)
...
e["Problem"]["Objective Function"] = lambda s : be.fBurger( s, args.N, args.episodelength, args.ic )
