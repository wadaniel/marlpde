...
import sys
sys.path.append('_model')
import ks_environment as ke

ke.dns.IC(case=args.ic)
ke.dns.simulate()
ke.dns.fou2real()
 
## restart
v_restart = ke.dns.vv[-1,:].copy()
u_restart = ke.dns.uu[-1,:].copy()
 
# set IC
ke.dns.IC( v0 = v_restart )

# continue simulation
ke.dns.simulate( nsteps=ke.nSimSteps, restart = True )
...
resultFolder = '_result_ks_{}_{}_{}_{}_{}/'.format(args.ic, args.N, args.numactions, args.episodelength, args.run)
...
e["Problem"]["Environment Function"] = lambda s : ke.environment( s, args.N, args.numactions, args.episodelength )
