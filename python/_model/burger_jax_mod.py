...
@jit
def jexpl_euler(actions, u, v, basis, dt, nu, k1, k2):
...
class burger_jax_mod:
    ...
    def grad(self, actions, u, v, n):
        return jacfwd(jexpl_euler, has_aux=True, argnums=(0,1))(actions, u, v, self.basis, self.dt, self.nu, self.k1, self.k2)[0]
